...
if ($_GET["mode"] == "vote") {
	...
	slowDie("Thank you for your vote.  Your vote (<b>$v</b>) has been cast. <br><a href=\"Javascript:history.go(-1);\">Go Back</a>");
}
...
if ($res) {
	...
	while ( $enreg=@mysql_fetch_array($res)) {
		...
		if ($plugin_versionvalue < $newest_versionvalue) echo "<br /><b>A newer $newest_state version is available:<br />[ <a href=\"dl.php?plugin_id=$newest_id&plugin_version=$newest_version&plugin_state=$newest_state\">Download Newer $newest_state</a> ] - [ <a href='detail.php?plugin_id=$newest_id&plugin_version=$newest_version&plugin_state=$newest_state'>Full Details for $newest_state</a> ]<br />";
		echo "<br />\n";
