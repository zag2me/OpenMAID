...
printPluginInfo("<tr valign=top><td align='right' NOWRAP>","Plugin Wiki", "http://www.meedios.com/wiki/index.php?title=Plugin_" . trim($plugin_id,"{}") ,"</td><td>","</td></tr>","");
...
//if ($plugin->plugin_VersionValue < $newest_versionvalue) echo "<p><a href=\"dl.php?plugin_id=$newest_id&plugin_version=$newest_version&plugin_state=$newest_state\"><b>Download Latest $newest_state</b> (" . formatFileSize($newest_downloadsize) . ")</a><br />";
