...
if (!isset($_FILES["userfile"]) && !isset($_FILES["pluginfile"]))
{
	...
	echo "<table border=0 align=\"center\"><tr><td align=\"center\"><b>UPLOAD PLUGIN</b><br /><br />Use this form to upload any type of add-in. The add-in must be a compressed zip archive, but can be any extension (e.g., .zip, .mpp). If your upload file size is larger than " . ini_get('post_max_size') . "B it will most likely fail, in which case <a href='mailto:slug@skyforge.net'>contact us</a> and provide a http download link for manual insertion.<br /><br />";
